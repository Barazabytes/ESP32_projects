/**
 * @file wifi_service_access_point.c
 * @brief This file contains the implementation of the Wi-Fi service in access point mode.
 *      - Initializes the Wi-Fi service with the provided SSID and password.
 *      - Sets up event handlers for station connections and disconnections.
 *      - Configures the Wi-Fi access point with specified parameters such as channel, maximum connections, and authentication mode.
 *      - Starts the Wi-Fi service and logs the configuration details.
